 ...
 */
open class ParallelFitnessResolver(genotypes: ArrayList<Genotype>, settings: BodySettings) :
    ...
    override fun resolve(): List<FitnessResult> {
        ...
        return markedGenotypes.parallelStream().map { genoPair: Pair<Genotype, Int> -> runTest(genoPair) }
