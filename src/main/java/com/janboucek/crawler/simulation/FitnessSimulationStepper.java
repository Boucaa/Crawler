...
public class FitnessSimulationStepper {
    ...
    private static final float SPEED_MULTIPLIER = 4.5f;
    private static final int STARTUP_FRAMES = 30; //frames at the start when the robot is falling and is not allowed to move
    private static final double TOUCH_CHANGE_SPEED = 0.08;
