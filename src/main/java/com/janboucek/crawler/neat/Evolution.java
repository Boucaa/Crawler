...
public class Evolution {
    ...
    private static final double DEFAULT_WEIGHT_RANGE = 4.5;

    //mutation chances
    private static final double MUTATE_ADD_NODE = 0.07;
    private static final double MUTATE_ADD_CONNECTION = 0.15;
    private static final double MUTATE_ENABLE_DISABLE = 0.4; //0
    private static final double MUTATE_WEIGHT = 0.8; //the chance of mutating connection weights //0.8
    private static final double MUTATE_WEIGHT_SMALL = 0.9; //if the connections are to be changed, this decides the small/random ratio
    private static final double MUTATE_SINGLE_INSTEAD = 0.1; //chance of mutating only a single weight
    private static final double MUTATE_FUNCTION = 0.15;

    private static final double MUTATE_SMALL_LIMIT = 0.05; //0.05

    private static final double COMPAT_1 = 1.5;
    private static final double COMPAT_2 = 1.5;
    private static final double DELTA_T = 3.0;

    private static final double CROSSOVER = 0.75;
    private static final double KILL_OFF = 0.5;
